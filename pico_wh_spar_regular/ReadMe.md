...
Enable bluetooth on your mobile, before starting the app, if you want to use the BLE option to connect. You can use both BLE as well as WiFi in this Pico WH board.
