...
Ensure you have installed the CP2102 or equivalent USB drivers into your system, so the serial communication with the Arduino Nano can happen through the USB cable.
