...
In Windows 10 or 11, download the spar_flasher_arduino_uno_regular_windows.zip first, to upload the precompiled firmware to your Arduino Nano board.
In Linux, download the spar_flasher_arduino_uno_regular_linux.zip, to upload the precompiled firmware to your Arduino Uno board.
After downloading the zip file, extract it to your desktop.
Ensure you have installed the CP2102 or equivalent USB drivers into your system, so the serial communication with the Arduino Uno can happen through the USB cable.
...
Enable bluetooth on your mobile, before starting the app.
